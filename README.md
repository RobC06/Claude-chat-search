...
5. You'll see "Search for Claude Chats" appear. Pin it to your toolbar if you like.

## Using it

1. Open [claude.ai](https://claude.ai) in a tab and make sure you're logged in.
2. Click the **Search for Claude Chats** icon in your toolbar — the side panel opens.
